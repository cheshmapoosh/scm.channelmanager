# AGENTS.md - scm-provider-nab

## Module Purpose

NAB provider implementation module.

Contain NAB-specific provider integration logic and error mapping.
...
Before completing a change in `scm-provider-nab`:
