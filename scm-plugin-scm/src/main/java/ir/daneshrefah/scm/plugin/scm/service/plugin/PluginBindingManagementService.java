...
@Service
public class PluginBindingManagementService extends AbstractJavaService {

    private final PluginResolverService pluginResolverService;

    public PluginBindingManagementService(ServiceProducerTemplate producerTemplate, ObjectMapper objectMapper, PluginResolverService pluginResolverService) {
        super(producerTemplate, objectMapper);
        this.pluginResolverService = pluginResolverService;
    }

    @JavaService(operationCode = OperationCode.SVC_PLUGIN_BINDINGS_BY_ID)
    public PluginBindingResponse getPluginBindingsById(PluginBindingRequest request) {
        return pluginResolverService.getPluginBindingById(request);
    }
    ...
    @JavaService(operationCode = OperationCode.SVC_PLUGIN_BINDINGS_SEARCH)
    public PluginBindingSearchResponse getPluginBindingsByScopeAndScopeId(PluginBindingRequest request) {
        return pluginResolverService.getPluginBindingsByScopeAndScopeId(request);
    }
