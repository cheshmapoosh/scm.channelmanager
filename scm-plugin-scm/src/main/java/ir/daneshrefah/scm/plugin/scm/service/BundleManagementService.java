...
public class BundleManagementService extends AbstractJavaService {
    ...
    @JavaService(operationCode = SVC_BUNDLE_LIST)
    ...
    @JavaService(operationCode = SVC_BUNDLE_LIST_FIND_BY_ID)
    ...
    @JavaService(operationCode = SVC_BUNDLE_EDIT)
