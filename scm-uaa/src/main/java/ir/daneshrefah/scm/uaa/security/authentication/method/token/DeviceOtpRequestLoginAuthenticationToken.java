...
public class DeviceOtpRequestLoginAuthenticationToken extends UserLoginAuthenticationToken {

    public DeviceOtpRequestLoginAuthenticationToken(TerminalUserDetails user, PreAuthenticationToken preAuthenticationToken) {
