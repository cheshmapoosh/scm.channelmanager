package ir.daneshrefah.scm.uaa.exception.resolver;
...
public class AuthorizationDeniedExceptionResolver extends ExceptionResolver<AuthorizationDeniedException> {

    private final ExceptionMessageBundleProvider messageBundleProvider;
    private final ErrorMappingService errorMappingService;

    @Override
    public List<Error> resolve(AuthorizationDeniedException exception, Locale locale) {
    ...
    private String getMessage(Locale locale, AuthorizationDeniedException exception) {
