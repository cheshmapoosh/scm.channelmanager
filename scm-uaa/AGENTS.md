...
Handle authentication, token issuing and UAA-specific persistence. Login tracing may be implemented here, but never record secrets.
...
Before completing a change in `scm-uaa`:
