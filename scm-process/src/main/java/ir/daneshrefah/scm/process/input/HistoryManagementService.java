...
import static ir.daneshrefah.scm.common.constant.ServiceCode.SVC_PROCESS_HISTORY_LIST;
import static ir.daneshrefah.scm.common.constant.ServiceCode.SVC_PROCESS_TASK_DETAIL_HISTORY_LIST;
...
public class HistoryManagementService extends AbstractJavaService {
    ...
    @JavaService(serviceCode = SVC_PROCESS_HISTORY_LIST)
    ...
    @JavaService(serviceCode = SVC_PROCESS_TASK_DETAIL_HISTORY_LIST)
