# AGENTS.md - scm-message-queue

## Module Purpose

Messaging abstraction module.

Contain MQ/JMS abstractions and common message queue utilities.
...
Before completing a change in `scm-message-queue`:
