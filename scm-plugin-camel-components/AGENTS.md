# AGENTS.md - scm-plugin-camel-components

## Module Purpose

Custom Camel component/plugin support module.

Contain reusable Camel components used by plugin/gateway flows.
...
Before completing a change in `scm-plugin-camel-components`:
