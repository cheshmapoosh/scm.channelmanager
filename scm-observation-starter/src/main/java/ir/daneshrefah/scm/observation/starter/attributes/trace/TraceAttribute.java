package ir.daneshrefah.scm.observation.starter.attributes.trace;
...
public final class TraceAttribute {
    ...
    public static ObservationAttributeKey<Integer> integerNumber(
            String name, ObservationAttributePresence presence, String description) {
        return integerNumber(name, "common", presence, description);
    }

    public static ObservationAttributeKey<Long> longNumber(
            String name, ObservationAttributePresence presence, String description) {
        return longNumber(name, "common", presence, description);
    }

    public static ObservationAttributeKey<Double> doubleNumber(
            String name, String owner, ObservationAttributePresence presence, String description) {
        return attribute(name, ObservationAttributeTypes.DOUBLE, owner, presence,
                ObservationAttributeSensitivity.RAW, 0, 0, description);
    }

    public static ObservationAttributeKey<Double> doubleNumber(
            String name, ObservationAttributePresence presence, String description) {
        return doubleNumber(name, "common", presence, description);
    }
    ...
    private static <T> ObservationAttributeKey<T> attribute(
        ...
        return ObservationAttributeKey.key(name, type, owner, presence, sensitivity,
                visiblePrefixLength, visibleSuffixLength, description, ObservationStream.TRACE);
    }
