...
public final class CommonTraceAttributes {
    ...
    public static final ObservationAttributeKey<List<?>> SPAN_EVENTS = TraceAttribute.object(
            "span.events", listType(), ObservationAttributePresence.EVENT_OPTIONAL, "Ordered structured span events.");
