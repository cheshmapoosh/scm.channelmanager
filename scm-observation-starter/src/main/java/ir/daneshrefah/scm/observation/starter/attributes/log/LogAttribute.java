package ir.daneshrefah.scm.observation.starter.attributes.log;
...
public final class LogAttribute {
    ...
    public static ObservationAttributeKey<Integer> integer(
            String name, String owner, ObservationAttributePresence presence, String description) {
    ...
    private static <T> ObservationAttributeKey<T> attribute(
        ...
        return ObservationAttributeKey.key(name, type, owner, presence, sensitivity,
                visiblePrefixLength, visibleSuffixLength, description, ObservationStream.LOG);
    }
