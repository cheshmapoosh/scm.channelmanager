...
//            if (!javaServiceAnnotation.operationCode().getType().equals(ServiceImplementationType.JAVA)){
//                log.error(">>> SERVICE CODE '{}' MUST HAVE JAVA IMPL TYPE", javaServiceAnnotation.operationCode().name());
//                throw new RuntimeException("MUST HAVE JAVA IMPL TYPE");
//            }
//            metadata.setCode(javaServiceAnnotation.operationCode());
