...
import ir.daneshrefah.scm.core.integration.plugin.specific.DestinationIbanBankNotAllowedException;
...
public class DestinationIbanBankNotAllowedExceptionResolver
        extends ExceptionResolver<DestinationIbanBankNotAllowedException> {

    private final ExceptionMessageBundleProvider messageBundleProvider;

    @Override
    public List<Error> resolve(DestinationIbanBankNotAllowedException exception, Locale locale) {
    ...
    private String resolveMessage(Locale locale, DestinationIbanBankNotAllowedException exception) {
