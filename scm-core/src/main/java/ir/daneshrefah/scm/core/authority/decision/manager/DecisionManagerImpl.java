...
import ir.daneshrefah.scm.core.authority.decision.voter.AuthenticationDecisionVoter;
import ir.daneshrefah.scm.core.authority.decision.voter.ConditionsDecisionVoterImpl;
import ir.daneshrefah.scm.core.authority.decision.voter.TransactionAuthenticationDecisionVoter;
...
public class DecisionManagerImpl implements DecisionManager {
    ...
    private final ConditionsDecisionVoterImpl conditionsDecisionVoter;
    ...
    public DecisionManagerImpl(ConditionsDecisionVoterImpl conditionsDecisionVoter) {
        this.conditionsDecisionVoter = conditionsDecisionVoter;
