...
Core service/operation orchestration module.

Contain core runtime abstractions, policies, routing strategies and service orchestration.
...
Before completing a change in `scm-core`:
