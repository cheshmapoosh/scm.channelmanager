...
import ir.daneshrefah.scm.log.entity.LogPrimaryKey;
import ir.daneshrefah.scm.log.entity.LogTraceEntity;
import ir.daneshrefah.scm.log.model.LogTraceResponse;
...
public interface LogTraceRepository extends JpaRepository<LogTraceEntity, LogPrimaryKey>{
    ...
    @Query("SELECT new ir.daneshrefah.scm.log.model.LogTraceResponse(" +
