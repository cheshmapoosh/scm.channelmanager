...
| `SCM_APPLICATION_NAME` | نام برنامه | نام Spring application است و معمولاً باید `scm-logging` باشد. |
| `SCM_INSTANCE_ID` | شناسه نمونه | شناسه node یا pod است و برای عیب یابی مصرف MQ و insertها استفاده میشود. |
