# AGENTS.md - scm-logging

## Module Purpose

Centralized logging service.

Read logs from IBM MQ, persist them, implement idempotency and protect against duplicate delivery.
...
Before completing a change in `scm-logging`:
