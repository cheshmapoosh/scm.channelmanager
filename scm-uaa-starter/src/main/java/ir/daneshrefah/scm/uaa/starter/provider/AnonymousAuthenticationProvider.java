...
import ir.daneshrefah.scm.uaa.starter.provider.token.AnonymousAuthenticationToken;
...
public class AnonymousAuthenticationProvider extends AbstractClientAuthenticationProvider {
    ...
    public AnonymousAuthenticationProvider(SessionCache sessionCache, CacheManager cacheManager) {
