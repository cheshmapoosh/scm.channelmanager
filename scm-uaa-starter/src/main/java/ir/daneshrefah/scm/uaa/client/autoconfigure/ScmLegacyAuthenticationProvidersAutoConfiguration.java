...
import ir.daneshrefah.scm.uaa.client.provider.AnonymousAuthenticationProvider;
import ir.daneshrefah.scm.uaa.client.provider.BasicRemoteAuthenticationProvider;
import ir.daneshrefah.scm.uaa.client.provider.BearerAuthenticationProvider;
import ir.daneshrefah.scm.uaa.client.provider.ClaimRemoteAuthenticationProvider;
import ir.daneshrefah.scm.uaa.client.provider.ClientRemoteAuthenticationProvider;
import ir.daneshrefah.scm.uaa.client.provider.SessionAuthenticationProvider;
import ir.daneshrefah.scm.uaa.client.remote.LocalSecurityServiceProvider;
