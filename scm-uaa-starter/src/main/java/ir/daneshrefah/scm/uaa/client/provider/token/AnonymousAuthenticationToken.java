...
public class AnonymousAuthenticationToken extends BaseTerminalAuthenticationToken {
     ...
     */
    public AnonymousAuthenticationToken(String username, String terminalCode, String clientId, String accessParameter, Collection<? extends GrantedAuthority> authorities) {
        super(username, terminalCode, clientId, accessParameter, authorities);
