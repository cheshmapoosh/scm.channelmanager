# AGENTS.md - scm-notification-client

## Module Purpose

Client library module `scm-notification-client`.

Expose reusable client APIs for other modules. Keep it lightweight and avoid runtime-server responsibilities.
...
Before completing a change in `scm-notification-client`:
