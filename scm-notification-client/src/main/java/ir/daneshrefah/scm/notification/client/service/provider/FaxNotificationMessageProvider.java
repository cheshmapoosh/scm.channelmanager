 ...
 */
@Component
public class FaxNotificationMessageProvider implements NotificationMessageProvider {
    ...
    public boolean supports(NotificationMessage notificationMessage) {
        return Objects.nonNull(notificationMessage) && Objects.nonNull(notificationMessage.getRequest()) &&
                NotificationMedia.FAX.equals(notificationMessage.getRequest().getMedia());
    }
