# AGENTS.md - scm-task-provider

## Module Purpose

Internal task/process operation provider module.

Contains task/process management rules and exposes them as JavaService operations.
Workflow routing and gateway exposure belong to their owning layers.
...
Before completing a change in `scm-task-provider`:
