...
//    private final CacheClientProperties clientProperties;
    ...
    @Bean
    @ConditionalOnProperty(name = "scm.cache.client.distributed", havingValue = "true", matchIfMissing = true)
...
//            setupSerializationConfig(clientConfig);
    ...
    @Bean
    @ConditionalOnProperty(name = "scm.cache.client.distributed", havingValue = "false", matchIfMissing = false)
