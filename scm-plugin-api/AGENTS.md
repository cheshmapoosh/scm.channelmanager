# AGENTS.md - scm-plugin-api

## Module Purpose

Plugin contract module.

Define plugin interfaces, types, phases and execution contracts. Keep it stable and dependency-light.
...
Before completing a change in `scm-plugin-api`:
