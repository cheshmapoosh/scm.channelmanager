# AGENTS.md - scm-provider-shetab

## Module Purpose

Shetab provider implementation module.

Contain Shetab-specific integration logic and mapping. Do not leak Shetab-specific details upward.
...
Before completing a change in `scm-provider-shetab`:
