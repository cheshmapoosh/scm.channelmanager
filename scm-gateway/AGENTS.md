# AGENTS.md - scm-gateway

## Module Purpose

Gateway layer library.

Contain protocol/gateway abstractions and route integration logic. Avoid business provider logic.
...
Before completing a change in `scm-gateway`:
