# AGENTS.md - scm-plugin-pichack

## Module Purpose

Plugin implementation module `scm-plugin-pichack`.

Implement plugin behavior for its domain/provider while respecting plugin API contracts.
...
Before completing a change in `scm-plugin-pichack`:
