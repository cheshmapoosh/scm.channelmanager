# AGENTS.md - scm-uaa-common

## Module Purpose

`scm-uaa-common` module.

Follow root architecture and keep this module focused on its existing responsibility.
...
Before completing a change in `scm-uaa-common`:
