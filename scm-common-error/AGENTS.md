# AGENTS.md - scm-common-error

## Module Purpose

Common error model module.

Contain shared error abstractions such as SCMFault/SCMException related models.
...
Before completing a change in `scm-common-error`:
