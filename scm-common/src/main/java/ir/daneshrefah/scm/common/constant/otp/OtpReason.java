...
public enum OtpReason {
    ...
    AUTHENTICATION(2, 4, OtpPattern.NUMERIC, NotificationTemplate.AUTHENTICATION_OTP, 0, 1,1),
    CHANGE_LOGIN_AUTHENTICATION_METHOD(2, 4, OtpPattern.NUMERIC, NotificationTemplate.AUTHENTICATION_OTP, 0, 1,2),
    CHANGE_TRANSACTION_AUTHENTICATION_METHOD(2, 4, OtpPattern.NUMERIC, NotificationTemplate.AUTHENTICATION_OTP, 0, 1,3),
