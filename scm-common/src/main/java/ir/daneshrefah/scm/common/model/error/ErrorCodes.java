...
public class ErrorCodes {
    ...
    public static final int ERROR_CODE_DUPLICATE_RECORD = 1003;
    public static final int ERROR_CODE_INPUT_IS_INVALID = 1004;
    public static final int ERROR_CODE_DATE_INPUT_IS_INVALID = 1004;
    public static final int ERROR_CODE_MISSING_REQUIRED_INPUT = 1005;
    public static final int ERROR_CODE_TOO_MANY_RECORD_FOUND = 1006;
    public static final int ERROR_CODE_ACCESS_DENIED = 1007;
    public static final int ERROR_CODE_INVALID_REMOTE_RESPONSE = 1008;
    public static final int ERROR_CODE_UNSUCCESSFUL_PROVIDER_RESPONSE = 1017;
    public static final int ERROR_CODE_REQUEST_IS_NULL = 1009;
    public static final int ERROR_CODE_SOCKET_TIMEOUT = 1010;
    public static final int ERROR_CODE_UNKNOWN_HOST = 1011;
    public static final int ERROR_CODE_HOST_UNREACHABLE = 1014;
    public static final int ERROR_CODE_NO_RECORD_FOUND = 1012;
    public static final int ERROR_CODE_NOT_SUPPORT_DATA = 1013;
    public static final int ERROR_CODE_INVALID_REQUEST_FORMAT = 1014;
    public static final int ERROR_CODE_VALIDATION_NO_DATA_CHANGE = 1063;
    ...
    public static final int ERROR_CODE_VIOLATION_DATA_INTEGRITY = 1021;
    public static final int ERROR_CODE_VALIDATION_GLOBAL = 1005;
