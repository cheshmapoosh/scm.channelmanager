...
public class RestExternalServiceProviderException extends AbstractBaseException {
    ...
    public RestExternalServiceProviderException(ResponseCondition responseCondition,String provider,String serviceCode) {
        this(responseCondition, provider,serviceCode,"default rest exception", null);

    }

    public RestExternalServiceProviderException(ResponseCondition responseCondition,String provider,String serviceCode, String technicalMessage, Throwable cause) {
