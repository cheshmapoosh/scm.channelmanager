# AGENTS.md - scm-config

## Module Purpose

Spring Cloud Config Server module.

Manage centralized configuration, config API, security and Git/YAML config storage.
...
Before completing a change in `scm-config`:
