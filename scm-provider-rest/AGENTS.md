# AGENTS.md - scm-provider-rest

## Module Purpose

Reusable REST provider implementation module.

Provide generic REST provider capabilities. Must be reusable for multiple REST providers.
...
Before completing a change in `scm-provider-rest`:
