...
Main Gateway/ChannelManager boot application.

Host gateway runtime, Camel routes, provider wiring and channel execution. Do not place UAA or Config Server behavior here.
...
Before completing a change in `scm-web`:
