# AGENTS.md - scm-cache-starter

## Module Purpose

Cache client module.

Expose reusable cache access APIs for other modules without coupling them to server internals.
...
Before completing a change in `scm-cache-starter`:
