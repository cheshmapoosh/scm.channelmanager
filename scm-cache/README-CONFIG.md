...
| `SCM_APPLICATION_NAME` | نام برنامه | نام Spring application است و معمولاً باید `scm-cache` باشد. |
| `SCM_INSTANCE_ID` | شناسه نمونه | شناسه node یا pod است. اگر تکراری باشد تشخیص عضو مشکل دار سخت میشود. |
