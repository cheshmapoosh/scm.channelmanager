# AGENTS.md - scm-common-data

## Module Purpose

Common data/persistence support module.

Contain reusable data abstractions and shared persistence concerns.
...
Before completing a change in `scm-common-data`:
